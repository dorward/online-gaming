...
const IndexPage = () => {
	return (
		<Layout>
			...
			<p>If you have any questions, problems or suggestions for improvements then please contact <a href="mailto:info@consequences.org.uk">info@consequences.org.uk</a>.</p>
		</Layout>
	);
};
